    ...
    <section id="top" className="mx-auto max-w-[1440px] px-5 pt-12 md:px-10 md:pt-20">
      <div className="grid grid-cols-12 gap-7">
        <div className="col-span-12 flex flex-col justify-between lg:col-span-5">
          <div className="animate-rise"><p className="mb-6 font-mono text-[11px] uppercase text-muted-foreground">(a) — Studio kiến trúc & nội thất</p><h1 className="font-display font-extrabold text-[clamp(2.75rem,6vw,5.25rem)] uppercase leading-[1.08]"><span className="block">Đi vào</span><span className="block text-primary">không gian</span><span className="block">bằng ánh sáng</span></h1></div>
